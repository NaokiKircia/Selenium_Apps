...
class SearchHotelPage:
    ...
    def set_date_range(self, check_in, check_out):
        self.logger.info("Setting {checkin} and {checkout} dates".format(checkin=check_in, checkout=check_out))
    ...
    def set_travellers(self, adults, child):
        self.logger.info("Setting travellers adults- {adults} and kids- {kids}".format(adults=adults, kids=child))
